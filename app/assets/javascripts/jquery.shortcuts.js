...
(function($) {
    ...
    var special = {
        ...
        'f12': 123,
        '?': 191, // Question mark
        'minus': $.support.opera ? [109, 45] : $.support.mozilla ? 109 : [189, 109],
        'plus': $.support.opera ? [61, 43] : $.support.mozilla ? [61, 107] : [187, 107]
    };
    ...
    $.Shortcuts.start = function(list) {
        ...
        $(document).bind(($.support.opera ? 'keypress' : 'keydown') + '.shortcuts', function(e) {
